        ...
        >
          ...
          <ul className="lg:flex gap-x-5 max-lg:space-y-3">
            ...
            <li className="block lg:hidden">
              <button
                onClick={toggleTheme}
                className="flex items-center justify-center w-full text-black hover:text-gray-500"
              >
                {theme === "light" ? "🌞" : "🌜"}
              </button>
            </li>
        ...
        <div className="flex items-center space-x-4">
          {!user ? (
            <>
              ...
              <button
                onClick={toggleTheme}
                className="hidden lg:block px-4 py-2 rounded text-black hover:text-gray-500"
              >
                {theme === "light" ? "🌞" : "🌜"}
              </button>
            </>
