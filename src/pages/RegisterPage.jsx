...
//                   required
//                   className="w-full bg-transparent text-sm border-b border-gray-300 focus:border-black px-2 py-3 outline-none"
...
//                 <Link to="/login">
//                   <a className="text-black font-semibold hover:underline ml-1">
//                     Login here
//                   </a>
//                 </Link>
//               </p>
